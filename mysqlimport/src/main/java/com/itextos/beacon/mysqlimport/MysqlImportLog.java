...
public class MysqlImportLog {


    private static final  Logger logger = Logger.getLogger(MysqlImportLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = "/opt/jboss/wildfly/logs/mysqlimport.%g.log";
