package com.itextos.beacon.jettyserver.dlrquery;
...
public class QueryEngine
{
	...
	public static void addDLRQuery(Server server2) {
		
		final ServletContextHandler handler = new ServletContextHandler(server2, "/dlrquery");

        log.info("Preparing api routes");
        handler.addServlet(com.itextos.beacon.dlrquery.servlet.DlrQueryRequest.class.getName(), "/query");
