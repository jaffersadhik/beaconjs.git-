package com.itextos.beacon.commonlib.kafka.data;
...
import com.itextos.beacon.commonlib.kafka.data.db.KafkaClusterComponentMap;
import com.itextos.beacon.commonlib.kafka.data.db.KafkaClusterInfo;
...
import com.itextos.beacon.commonlib.kafka.service.consumer.Consumer;
import com.itextos.beacon.commonlib.kafka.service.consumer.ConsumerInMemCollection;
import com.itextos.beacon.commonlib.kafka.service.consumer.KafkaConsumerProperties;
import com.itextos.beacon.commonlib.kafka.service.producer.KafkaProducerProperties;
import com.itextos.beacon.commonlib.kafka.service.producer.Producer;
import com.itextos.beacon.commonlib.kafka.service.producer.ProducerInMemCollection;
...
public class KafkaInformation
{
            ...
            KafkaClusterInfo aKafkaClusterInfo)
    {
        ...
        final String                      lKafkaServerProducerPropertiesPath = aKafkaClusterInfo.getKafkaConsumerProperties();
