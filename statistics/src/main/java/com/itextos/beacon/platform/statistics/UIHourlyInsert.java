...
public class UIHourlyInsert {
	...
	public static void doProcess(Map<String,Map<String,String>> cli_id_infomap,Map<String,String> carrier_infomap) {
		...
		Map<String,Map<String,Map<String,String>>> hourlyStatisticsdata=UIHourlyQuery.getHourlyData(carrier_infomap);
		...
		Set<String> dateset=UIHourlyQuery.getAvailableDays(hourlyStatisticsdata);
	...
	private static void insertMixTraffic(Connection con, Map<String, Map<String, String>> cli_id_infomap,
    	...
    	try {
    		...
    		int [] result=pstmt.executeBatch();
    		int count =getCount(result);
    		StatisticsLog.log("ui_traffic_mix_report inserted : "+count);
