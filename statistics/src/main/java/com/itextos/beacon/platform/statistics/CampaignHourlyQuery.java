	...
	private static void setHourlyData(Map<String, Map<String, Map<String, String>>> result,Map<String,String> carrier_infomap, String sql) {
		...
		for(int i=0;i<datalist.size();i++) {
			...
			Map<String,String> data=datalist.get(i);
			 ...
			 String msg_tag=data.get("msg_tag")==null?" ":data.get("msg_tag");			 
			 String msg_tag1=data.get("msg_tag1")==null?" ":data.get("msg_tag1");			 
			 String msg_tag2=data.get("msg_tag2")==null?" ":data.get("msg_tag2");			 
			 String msg_tag3=data.get("msg_tag3")==null?" ":data.get("msg_tag3");			 
			 String msg_tag4=data.get("msg_tag4")==null?" ":data.get("msg_tag4");			 
			 String msg_tag5=data.get("msg_tag5")==null?" ":data.get("msg_tag5");			 

			 String file_id=data.get("file_id")==null?" ":data.get("file_id");			 
			 String file_name=data.get("file_name")==null?" ":data.get("file_name");			 
