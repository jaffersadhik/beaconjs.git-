...
public class StatisticsTimeLog {


    private static final  Logger logger = Logger.getLogger(StatisticsTimeLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = "/opt/jboss/wildfly/logs/statisticstime.%g.log";
