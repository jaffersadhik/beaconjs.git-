...
def proc_date(date_val, pg_conn, df_usr, df_car_db):
    ...
    sub_sub_ori_sts_code, sub_msg_type, del_dn_ori_sts_code
    ...
    cols = ['recv_hour', 'cli_id', 'route_id', 'sub_ori_sts_code', 'msg_type', 'dn_ori_sts_code']
    null_value = "~~NULL~~"
    ...
    group_cols = ['recv_hour', 'cli_id', 'carrier_name']
    ...
    df_cols = ['recv_hour', 'cli_id', 'username', 'pu_id', 'username_pu', 'su_id', 'username_su',
               ...
               'delivery_failed', 'platform_reject', 'nulldn', 'delivery_pct']
    ...
    pg_col_lst = 'recv_date, recv_hour, cli_id, username, pu_id, pu_username, ' \
                 ...
                 'nulldn, delivery_pct'
    pg_tbl_name = "summary.hourly_traffic_report"
    ...
    pg_col_lst = 'recv_date, cli_id, username, pu_id, pu_username, ' \
                 ...
                 'non_promo_sub_count, delivery_count, failed_count, platform_reject, ' \
                 'nulldn, delivery_pct'
    pg_tbl_name = "summary.daily_traffic_report"
...
def main():
    ...
    log_fn = "./log/pg_daily_summary_report_" + log_fn_dtsfx + ".log"
