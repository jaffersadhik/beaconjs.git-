package com.itextos.beacon.jettyserver.messagetool;
...
public class QueryEngine
{
	...
	public static void addMessagetool(Server server2) {
		
		final ServletContextHandler handler = new ServletContextHandler(server2, "/msgtool");

        log.info("Preparing api routes");
        
        handler.addServlet(com.itextos.beacon.platform.msgtool.servlet.MessageInfo.class.getName(), "/msginfo");
