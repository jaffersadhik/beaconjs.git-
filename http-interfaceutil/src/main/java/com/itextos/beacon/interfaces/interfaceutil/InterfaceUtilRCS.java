package com.itextos.beacon.interfaces.interfaceutil;
...
import com.itextos.beacon.interfaces.ifb.FallBackProcessRCS;
import com.itextos.beacon.interfaces.ifb.inmem.FallbackQRCS;

public class InterfaceUtilRCS
{

    private static final Log    log                = LogFactory.getLog(InterfaceUtilRCS.class);

    private static final String INTL_SERVICE_ALLOW = "sms~international";

    private InterfaceUtilRCS()
    {}
            ...
            MessageRequest aMessageRequest)
    {
        ...
        else
        {
            ...
            try
            {
                MessageProcessor.writeMessage(Component.INTERFACES, Component.ICRCS, FallbackQRCS.getInstance().getBlockingQueue(), aMessageRequest);
                status = true;
            }
            ...
            MessageRequest aMessageRequest)
    {
        ...
        try
        {
            FallBackProcessRCS.sendToFallBack(aMessageRequest);
        }
