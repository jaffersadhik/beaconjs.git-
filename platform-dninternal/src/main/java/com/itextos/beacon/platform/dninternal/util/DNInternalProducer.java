package com.itextos.beacon.platform.dninternal.util;
...
public class DNInternalProducer
{

    private static final Log log = LogFactory.getLog(DNInternalProducer.class);

    private DNInternalProducer()
    {}
