package com.itextos.beacon.platform.dninternal.process;
...
import com.itextos.beacon.platform.dninternal.util.DNInternalProducer;
        ...
        AbstractKafkaComponentProcessor
{
    ...
    public static void forDLRInternal(final DeliveryObject lDeliveryObject,SMSLog sb) {
    	 ...
    	 try
         {
             ...
             DNInternalProducer.sendToNextComponents(processInternalDNQ,sb);
         }
         catch (final Exception e)
         {
             log.error("Exception occer while processing the  Internal Processor Dlr : ", e);

             DNInternalProducer.sendToErrorLog(lDeliveryObject, e);
         }
    }
    @Override
