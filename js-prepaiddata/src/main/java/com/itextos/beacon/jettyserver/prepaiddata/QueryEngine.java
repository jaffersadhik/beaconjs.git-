package com.itextos.beacon.jettyserver.prepaiddata;
...
public class QueryEngine
{
	...
	public static void addPrepaidData(Server server2) {
		
		final ServletContextHandler handler = new ServletContextHandler(server2, "/prepaiddata");

        log.info("Preparing api routes");
        handler.addServlet(com.itextos.beacon.platform.prepaiddata.servlets.PrepaidDataFetchServlet.class.getName(), "/prepaiddatafetchservlet");
        
        handler.addServlet(com.itextos.beacon.platform.prepaiddata.servlets.KannelInfoFetchServlet.class.getName(), "/kannelinfofetchservlet");

        handler.addServlet(com.itextos.beacon.platform.prepaiddata.servlets.PrepaidDataServlet.class.getName(), "/jsp/prepaiddata.jsp");
        
        handler.addServlet(com.itextos.beacon.platform.prepaiddata.servlets.KannelInfoServlet.class.getName(), "/jsp/kannelinfo.jsp");
