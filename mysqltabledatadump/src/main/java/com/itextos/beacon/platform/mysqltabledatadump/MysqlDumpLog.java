...
public class MysqlDumpLog {


    private static final  Logger logger = Logger.getLogger(MysqlDumpLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = "/opt/jboss/wildfly/logs/mysqldump.%g.log";
