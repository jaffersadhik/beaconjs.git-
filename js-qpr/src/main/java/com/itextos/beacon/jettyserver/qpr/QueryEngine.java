package com.itextos.beacon.jettyserver.qpr;
...
import com.itextos.beacon.queryprocessor.requestreceiver.CreateLogDataQueue;
import com.itextos.beacon.queryprocessor.requestreceiver.GetData;
import com.itextos.beacon.queryprocessor.requestreceiver.LogDataQueueList;
import com.itextos.beacon.queryprocessor.requestreceiver.LogDataQueueStatus;
...
public class QueryEngine
{
   ...
   // static final Properties  mySQL_cfg_val = new Properties();
	...
	public static void addQPR(Server server2) {
		
		final ServletContextHandler handler = new ServletContextHandler(server2, "/qpr");
