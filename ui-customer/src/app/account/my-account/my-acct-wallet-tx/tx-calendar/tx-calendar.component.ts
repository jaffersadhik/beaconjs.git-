...
@Component({
  selector: 'app-tx-calendar',
  templateUrl: './tx-calendar.component.html',
  styleUrls: ['./tx-calendar.component.css']
})
export class TxCalendarComponent implements OnInit {
  ...
  ngOnInit(): void {
//need to refresh token?? or taken care may be 
//if we update the token after the updating the tz, this might be taken care
