...
@Component({
  selector: 'app-downloaderrorpopup',
  templateUrl: './downloaderrorpopup.component.html',
  styleUrls: ['./downloaderrorpopup.component.css'],
  animations:[openClose]
})
export class DownloaderrorpopupComponent implements OnInit {
