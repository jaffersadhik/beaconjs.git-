...
public class DeliveriesKafkaInserter
        extends
        AbstractKafkaInserterWrapper
{

    private static final Log       log            = LogFactory.getLog(DeliveriesKafkaInserter.class);
    private static final Component THIS_COMPONENT = Component.K2E_DELIVERIES;

    public DeliveriesKafkaInserter(
            String aThreadName,
