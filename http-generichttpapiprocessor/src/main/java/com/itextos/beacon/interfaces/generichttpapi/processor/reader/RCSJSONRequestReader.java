...
import com.itextos.beacon.interfaces.generichttpapi.common.utils.InterfaceInputParameters;
...
import com.itextos.beacon.interfaces.generichttpapi.processor.request.RCSJSONRequestProcessor;
import com.itextos.beacon.interfaces.interfaceutil.MessageSource;
import com.itextos.beacon.interfaces.parameters.InterfaceParameter;
import com.itextos.beacon.interfaces.parameters.InterfaceParameterLoader;

import io.prometheus.client.Histogram.Timer;

public class RCSJSONRequestReader
        extends
        AbstractReader
{

    private static final Log log = LogFactory.getLog(RCSJSONRequestReader.class);
            ...
            String aJSonString)
    {
        ...
        try
        {
            overAllProcess = PrometheusMetrics.apiStartTimer(InterfaceType.HTTP_JAPI, MessageSource.RCS_JSON, APIConstants.CLUSTER_INSTANCE, mHttpRequest.getRemoteAddr(), OVERALL);
