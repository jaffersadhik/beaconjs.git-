...
import com.itextos.beacon.interfaces.generichttpapi.common.interfaces.IResponseProcessor;
import com.itextos.beacon.interfaces.generichttpapi.common.utils.APIConstants;
import com.itextos.beacon.interfaces.generichttpapi.common.utils.InterfaceMessageClass;
...
import com.itextos.beacon.interfaces.interfaceutil.InterfaceUtilRCS;

public class MiddlewareHandlerRCS
{

    private static final Log          log                      = LogFactory.getLog(MiddlewareHandlerRCS.class);
            ...
            throws Exception
    {
        ...
        InterfaceUtilRCS.sendToKafka(lMessageRequest);
    }
