package com.itextos.beacon.http.generichttpapi.processor.request;
...
import com.itextos.beacon.http.generichttpapi.processor.handover.MiddlewareHandlerRCS;
import com.itextos.beacon.http.generichttpapi.processor.response.GenerateJSONResponse;
import com.itextos.beacon.http.generichttpapi.processor.response.GenerateQueryStringResponse;
import com.itextos.beacon.http.generichttpapi.processor.validate.MessageValidater;
import com.itextos.beacon.http.interfaceutil.MessageSource;

public class RCSJSONRequestProcessor
        extends
        AbstractRequestProcessor
{
            ...
            String aResponseType)
    {
        ...
        if (MessageSource.GENERIC_QS.equals(aResponseType))
            ...
            if (MessageSource.RCS_JSON.equals(aResponseType))
            ...
            throws Exception
    {
        ...
        for (final Object lElement : aJsonDestination)
        {
            ...
            final MiddlewareHandlerRCS middlewareHandler = new MiddlewareHandlerRCS(aMessage, mBasicInfo, aMiddlewareStaus, destStatus);
    ...
    {
        Utility.setMessageId(aMessage);
        final MiddlewareHandlerRCS middlewareHandler = new MiddlewareHandlerRCS(aMessage, mBasicInfo, aMiddlewareStaus, InterfaceStatusCode.SUCCESS);
        middlewareHandler.middleWareHandover(aIsAsync, mResponseProcessor, mReqType);
    }
