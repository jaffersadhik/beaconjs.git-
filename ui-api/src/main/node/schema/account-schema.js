...
const anewSchema = {
    ...
    body: {
        type: 'object',
        required: ['user_type', 'firstname', 'lastname', 'company', 'username', 'email', 'mobile', 'zone_name', 'offset', 'allocated_tgroup_ids', 'assigned_tgroup_id', 'services', 'smpp_charset', 'billing_currency', 'intl_rates'],
        properties: {
...
const aupdatePISchema = {
    ...
    body: {
        type: 'object',
        required: ['cli_id', 'firstname', 'lastname', 'company', 'address'],
        properties: {
            cli_id: {
                type: 'integer',
                example: 6000000200000021,
...
const aupdateMSSchema = {
    ...
    body: {
        type: 'object',
        required: ['cli_id', 'zone_name', 'offset', 'newline_chars'],
        properties: {
            cli_id: {
                type: 'integer',
                example: 6000000200000021,
    ...
    body: {
        ...
        properties: {
            ...
            astatus: {
                ...
                description: 'activate/deactivate an account',
            },
        },
    },
    response: {
