...
public class SpecialStartApplication
{
    ...
    public static final Log log = LogFactory.getLog(SpecialStartApplication.class);
            ...
            String[] args)
    {
        ...
        try
        {
            ...
            final ModuleProcessorInfo lDnProcessor = new ModuleProcessorInfo(Component.DNP);
