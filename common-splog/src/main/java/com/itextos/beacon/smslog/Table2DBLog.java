...
public class Table2DBLog {
	...
	private static Map<String,Table2DBLog> objmap=new HashMap<String,Table2DBLog>();
	
	
	
	public static Table2DBLog getInstance(String topicname) {
	...
	private Table2DBLog(String username) {
