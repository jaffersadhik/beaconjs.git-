...
import com.itextos.beacon.commonlib.kafka.data.KafkaDBConstants;
import com.itextos.beacon.commonlib.kafka.data.KafkaDataLoader;
import com.itextos.beacon.commonlib.kafka.data.KafkaDataLoaderUtility;
import com.itextos.beacon.commonlib.kafka.data.KafkaInformation;
import com.itextos.beacon.commonlib.kafka.data.StartupRuntimeArguments;
import com.itextos.beacon.commonlib.kafka.data.db.KafkaClusterComponentMap;
import com.itextos.beacon.commonlib.kafka.data.db.KafkaComponentInfo;
        ...
        ShutdownHook
{
    ...
    private static final Log                log                               = LogFactory.getLog(ModuleProcessorInfo.class);
    ...
    public static void main(
            String[] args)
    {
        final ModuleProcessorInfo processorInfo = new ModuleProcessorInfo(Component.SBCV);
