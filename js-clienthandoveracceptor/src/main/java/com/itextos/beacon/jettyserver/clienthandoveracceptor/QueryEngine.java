package com.itextos.beacon.jettyserver.clienthandoveracceptor;
...
public class QueryEngine
{
            ...
            String[] args)
    {
        ...
        try
        {
            ...
            addClientHandoverAcceptor(server);
	...
	public static void addClientHandoverAcceptor(Server server2) {
		
		final ServletContextHandler handler = new ServletContextHandler(server2, "/clienthandoveraccept");

        log.info("Preparing api routes");
        handler.addServlet(com.itextos.beacon.clienthandover.accept.servlet.HandoverRequestAccepter.class.getName(), "/handoverrequest");
