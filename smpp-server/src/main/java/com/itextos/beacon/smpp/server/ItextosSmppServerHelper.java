package com.itextos.beacon.smpp.server;
...
import com.itextos.beacon.smpp.bind.BindRequestValidate;
import com.itextos.beacon.smpp.bind.ItextosBindUnbindInterface;
        ...
        SmppServerHandler
{
            ...
            throws SmppProcessingException
    {
        ...
        Metrics.sendBindReqLog(aSessionConfiguration, aBindRequest);
        ...
        BindRequestValidate.validateRequestOnBind(aBindRequest, sessionDetail);
    }
            ...
            SmppServerSession aServerSession)
    {
        ...
        Metrics.sendUnbindLog(aServerSession, "Request By User");
        ...
        Metrics.sendUnBindResponseLog(aServerSession);
    }
