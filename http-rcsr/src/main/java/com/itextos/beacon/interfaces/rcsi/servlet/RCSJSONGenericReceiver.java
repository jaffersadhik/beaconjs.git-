package com.itextos.beacon.interfaces.rcsi.servlet;
...
import com.itextos.beacon.interfaces.generichttpapi.processor.reader.RCSJSONRequestReader;
...
public class RCSJSONGenericReceiver
        extends
        BasicServlet
{
    ...
    private static final Log  log              = LogFactory.getLog(RCSJSONGenericReceiver.class);

    public RCSJSONGenericReceiver()
    {}
            ...
            IOException
    {
        ...
        PrometheusMetrics.apiIncrementAcceptCount(InterfaceType.HTTP_JAPI, MessageSource.RCS_JSON, APIConstants.CLUSTER_INSTANCE, aRequest.getRemoteAddr());

        final RequestReader reader = new RCSJSONRequestReader(aRequest, aResponse, MessageSource.RCS_JSON, "rcs");
            ...
            IOException
    {
        ...
        try
        {
            ...
            final RequestReader reader = new JSONRequestReader(aRequest, aResponse, MessageSource.GENERIC_JSON, "rcs");
