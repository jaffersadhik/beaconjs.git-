...
public class Prop {
	...
	public Properties getRedisQueue2Prop() {
		...
		String fileName = "/unitia/redisqueue2.prop";
	...
	public Properties getRedisQueue3Prop() {
		...
		String fileName = "/unitia/redisqueue3.prop";
	...
	public Properties getRedisQueue4Prop() {
		...
		String fileName = "/unitia/redisqueue4.prop";
	...
	public Properties getRedisProperties(String redisid) {
		if (redisid.equals("redisqueue1")) {
			...
			return getRedisQueue2Prop();

		} else if (redisid.equals("redisqueue3")) {

			return getRedisQueue3Prop();

		} else if (redisid.equals("redisqueue4")) {

			return getRedisQueue4Prop();
