...
public class Kannel {
	...
	public void reload() {
		...
		String sql="select dlr_storage,redis_host,redis_port,redis_database,redis_ttl,kannelid,kannel_host,sendsms_port,status_port,mysql_host,mysql_port,mysql_username,mysql_password,mysql_schema,mysql_tablename,sqlbox from  kannel_instance where status='1'";
		...
		try {
			...
			while(resultset.next()){
				...
				String redis_host=resultset.getString("redis_host");
				String redis_port=resultset.getString("redis_port");
				String redis_database=resultset.getString("redis_database");
				String redis_ttl=resultset.getString("redis_ttl");
				String dlr_storage=resultset.getString("dlr_storage");
				...
				prop.put("redis_host", redis_host);
				prop.put("redis_port", redis_port);
				prop.put("redis_database", redis_database);
				prop.put("redis_ttl", redis_ttl);
				prop.put("dlr_storage", dlr_storage);
