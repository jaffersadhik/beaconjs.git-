...
public class Kafka2ESConsumerThreadHRC
        extends
        ...
        ConsumerRebalanceListener
{
    ...
    // colValue = new
    // String(HexUtil.toByteArray(subObject.getMessage())).substring(0, 1000);
    // else
    // colValue = subObject.getMessage().substring(0, 1000);
    // break;
    //
    // case "msg_tag":
            ...
            throws Exception
    {
        ...
        for (final ConsumerRecord<String, IMessage> data : pDataList)
        {
            ...
            final String        msgId         = (String) dataJSON.get(this.ESIndexUniqueColumn);
