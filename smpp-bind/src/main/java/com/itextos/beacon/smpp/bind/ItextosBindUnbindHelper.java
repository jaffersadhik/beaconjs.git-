...
import com.itextos.beacon.smpp.counter.BindUnbindCounter;
...
import com.itextos.beacon.smpp.sessioninfo.handler.ItextosSmppSessionHandler;
        ...
        ItextosBindUnbindInterface
{
            ...
            throws SmppProcessingException
    {
        ...
        try
        {
            ...
            Metrics.sendBindActiveLog(aSessionDetail);
        }
        catch (final Exception e)
        {
            ...
            if (!(e instanceof SmppProcessingException))
            	...
            	Metrics.sendBindResposeLog(aSessionDetail);
            ...
            String aInformation)
    {
        ...
        Metrics.sendBindLog(aSessionDetail, bindInfoValid);
    }
            ...
            throws SmppProcessingException
    {
        ...
        catch (final Exception e)
        {
            ...
            Metrics.sendBindFailureLog(aSessionDetail, "0x" + HexUtil.toHexString(SmppConstants.STATUS_ALYBND), "Max Bind Exceeds");
            ...
            throws SmppProcessingException
    {
        ...
        catch (final Exception e)
        {
            ...
            Metrics.sendBindFailureLog(aSessionDetail, "0x" + HexUtil.toHexString(SmppConstants.STATUS_SYSERR), "Redis Bind increment exception");
