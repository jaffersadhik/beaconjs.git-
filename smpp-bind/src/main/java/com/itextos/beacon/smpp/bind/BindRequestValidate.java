package com.itextos.beacon.smpp.bind;
...
import com.itextos.beacon.smpp.prometheus.Metrics;
...
import com.itextos.beacon.smpp.schedule.TraiBlockoutCheck;
import com.itextos.beacon.smpp.submitsm.BuildMessageRequest;
...
public class BindRequestValidate
{

    private static final Log    log                    = LogFactory.getLog(BindRequestValidate.class);

    private static final String ACCOUNT_SMPP_BIND_TYPE = "smpp_bind_type";

    private BindRequestValidate()
    {}
      ...
      //      checkforBindTypeAllowed(aSessionDetail);
        ...
        catch (final Exception e)
        {
            ...
            if (!(e instanceof SmppProcessingException))
            {
                ...
                Metrics.sendBindFailureLog(aSessionDetail, "0x" + HexUtil.toHexString(SmppConstants.STATUS_SYSERR), "Internal Error");
   ...
   */
            ...
            throws SmppProcessingException
    {
        ...
        {
        	Metrics.sendBindFailureLog(aSessionDetail, "0x" + HexUtil.toHexString(SmppConstants.STATUS_INVDLNAME), "IP not whitelisted");
        	Metrics.sendUnbindInfoToDb(aSessionDetail, SmppConstants.STATUS_INVDLNAME, "IP not whitelisted");
            ...
            throws SmppProcessingException
    {
        ...
        {
        	Metrics.sendBindFailureLog(aSessionDetail, "0x" + HexUtil.toHexString(SmppConstants.STATUS_ALYBND), "Max Bind reached");
        	Metrics.sendUnbindInfoToDb(aSessionDetail, SmppConstants.STATUS_ALYBND, "Max Bind reached");
            ...
            throws SmppProcessingException
    {
        ...
        {
        	Metrics.sendBindFailureLog(aSessionDetail, "0x" + HexUtil.toHexString(SmppConstants.STATUS_ALYBND), "Instance Max Bind reached");
        	Metrics.sendUnbindInfoToDb(aSessionDetail, SmppConstants.STATUS_ALYBND, "Instance Max Bind reached");
            ...
            throws SmppProcessingException
    {
        ...
        {
        	Metrics.sendBindFailureLog(aSessionDetail, "0x" + HexUtil.toHexString(SmppConstants.STATUS_INVCMDID), "Invalid Bind Request Type");
        	Metrics.sendUnbindInfoToDb(aSessionDetail, SmppConstants.STATUS_INVCMDID, "Invalid Bind Request Type");
            ...
            throws SmppProcessingException
    {
        ...
        {
        	Metrics.sendBindFailureLog(aSessionDetail, "0x" + HexUtil.toHexString(SmppConstants.STATUS_SUBMITFAIL), "SMPP Service Disabled");
        	Metrics.sendUnbindInfoToDb(aSessionDetail, SmppConstants.STATUS_SUBMITFAIL, "SMPP Service Disabled");
            ...
            throws SmppProcessingException
    {
        ...
        {
        	Metrics.sendBindFailureLog(aSessionDetail, "0x" + HexUtil.toHexString(SmppConstants.STATUS_INVPASWD), "Account is not active.");
        	Metrics.sendUnbindInfoToDb(aSessionDetail, SmppConstants.STATUS_INVPASWD, "Account is not active.");
            ...
            throws SmppProcessingException
    {
        ...
        {
        	Metrics.sendBindFailureLog(aSessionDetail, "0x" + HexUtil.toHexString(SmppConstants.STATUS_INVPASWD), "Invalid Password");
        	Metrics.sendUnbindInfoToDb(aSessionDetail, SmppConstants.STATUS_INVPASWD, "Invalid Password");
            ...
            throws SmppProcessingException
    {
        ...
        {
        	Metrics.sendBindFailureLog(aSessionDetail, "0x" + HexUtil.toHexString(SmppConstants.STATUS_INVSYSID), "User not exists");
        	Metrics.sendUnbindInfoToDb(aSessionDetail, SmppConstants.STATUS_INVSYSID, "User not exists");
            ...
            throws SmppProcessingException
    {
        ...
        if ("".equals(systemId))
        {
        	Metrics.sendBindFailureLog(aSessionDetail, "0x" + HexUtil.toHexString(SmppConstants.STATUS_INVSYSID), "Empty SystemId");
        	Metrics.sendUnbindInfoToDb(aSessionDetail, SmppConstants.STATUS_INVSYSID, "Empty SystemId");
